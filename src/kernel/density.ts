...
export const computeDensitySignal = (u: U): Float64Array => {
  ...
  signal[0] = u.t.spacing.scale.reduce((a, b) => a + b, 0) / u.t.spacing.scale.length;
  return signal;
};
