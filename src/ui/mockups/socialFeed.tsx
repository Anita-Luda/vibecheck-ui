  ...
  <div className="max-w-2xl mx-auto space-y-[var(--spacing-8)]">
    <Card id={0}>
        <div className="flex gap-[var(--spacing-4)]">
            <div className="w-12 h-12 rounded-[var(--radius-full)] bg-[var(--color-support)] shrink-0" />
            <textarea
        ...
        <div className="flex justify-between items-center mt-[var(--spacing-4)] pt-4 border-t border-gray-200/10">
            <div className="flex gap-[var(--spacing-4)] text-xl">
    ...
    <div className="space-y-[var(--spacing-6)]">
        {[
            ...
            <Card key={i} id={(i % 2) + 1}>
                <div className="flex gap-[var(--spacing-4)]">
                    <div className="w-12 h-12 rounded-[var(--radius-full)] bg-[var(--color-accent)] shrink-0 opacity-80" />
                    <div className="space-y-2 flex-1">
                        ...
                        <div className="flex gap-[var(--spacing-8)] pt-4 text-xs font-bold text-[var(--color-text-muted)]">
