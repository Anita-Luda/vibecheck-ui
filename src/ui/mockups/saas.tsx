  ...
  <div className="max-w-6xl mx-auto space-y-12 py-12">
    ...
    <section className="grid grid-cols-2 gap-12 items-center">
        <div className="space-y-6">
            <div className="inline-flex items-center gap-2 bg-[var(--color-role-support-bg)] px-3 py-1 rounded-full border border-[var(--color-role-support-border)]">
            ...
            <div className="flex gap-4">
                <Button id={1} className="px-8 py-3">Zacznij za darmo</Button>
                <Button id={2} className="px-8 py-3 bg-transparent border-[var(--color-role-neutral-border)] text-[var(--color-text-primary)]">Dokumentacja API</Button>
            </div>
        </div>
        <Card id={0} className="font-mono p-8 shadow-2xl relative overflow-hidden">
            ...
            <div className="space-y-4 text-sm text-[var(--color-text-primary)]">
                <div className="flex gap-2"><span className="text-green-500 font-bold">$</span> vbc deploy --cluster potato-alpha</div>
                ...
                <div className="bg-[var(--color-surface-raised)] p-3 rounded border border-[var(--color-role-neutral-border)]">
                    <div className="text-[10px] text-gray-400 mb-2">OUTPUT LOGS:</div>
    ...
    <Grid cols={3}>
        {[
            ...
            <Card key={i} id={i+1} className="hover:scale-105 transition-transform cursor-pointer">
                <div className="w-12 h-12 rounded-2xl bg-[var(--color-role-accent-bg)] mb-6 flex items-center justify-center text-2xl border border-[var(--color-role-accent-border)]">
                    {['🥔', '🐈', '🛡️'][i]}
                </div>
    ...
    <div className="grid grid-cols-3 gap-8">
        <div className="col-span-2">
            <Card id={4} className="h-full">
                <h3 className="text-xl font-black mb-6">Konfiguracja Sektora</h3>
                ...
                <Button id={0} className="mt-4">Deploy Now</Button>
            </Card>
        </div>
