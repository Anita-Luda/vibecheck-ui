...
export const OnboardingMock = () => (
  <div className="max-w-4xl mx-auto py-20 text-center space-y-12">
    ...
    <div className="grid grid-cols-3 gap-8">
        {[
            ...
            <div key={i} className="space-y-4">
                <div className="w-10 h-10 rounded-full bg-[var(--color-support)] mx-auto flex items-center justify-center font-black text-[var(--color-text)] border border-gray-200/20 shadow-sm">
                    {item.step}
                </div>
    ...
    <div className="pt-8">
        ...
        <p className="mt-4 text-xs text-[var(--color-text-muted)]">Masz już konto? <span className="text-[var(--color-accent)] font-bold cursor-pointer hover:underline">Zaloguj się</span></p>
    </div>
  </div>
);
