...
export const EnterpriseMock = () => (
    <div className="flex h-[800px] border border-[var(--color-role-neutral-border)] rounded-[var(--radius-lg)] overflow-hidden bg-[var(--color-bg)]">
        {/* Sidebar Nav */}
        <aside className="w-16 hover:w-64 transition-all group border-r border-[var(--color-role-neutral-border)] bg-[var(--color-surface-raised)] flex flex-col p-4 z-20">
            <div className="w-8 h-8 bg-[var(--color-role-accent)] rounded-lg mb-12 flex-shrink-0" />
            <div className="flex-1 space-y-8 overflow-hidden">
                {[
                    ...
                    <div key={item.l} className="flex items-center gap-4 cursor-pointer hover:text-[var(--color-role-accent)] transition-colors whitespace-nowrap">
        ...
        <main className="flex-1 flex flex-col overflow-hidden bg-[var(--color-surface)]">
            <header className="h-16 border-b border-[var(--color-role-neutral-border)] px-8 flex items-center justify-between bg-white/50 backdrop-blur">
                ...
                <div className="flex gap-4">
                    <div className="flex items-center gap-2 px-3 py-1 bg-[var(--color-surface-raised)] rounded-full border border-[var(--color-role-neutral-border)]">
            ...
            <div className="flex-1 overflow-y-auto p-8 space-y-8">
                <div className="flex justify-between items-end">
                    <div>
                        ...
                        <p className="text-xs text-[var(--color-text-muted)] font-bold uppercase mt-1 tracking-widest">Macierz ról i dostępów globalnych</p>
                    </div>
                ...
                <Grid cols={2}>
                    ...
                    <Card id={4}>
                        <h3 className="text-lg font-black mb-6 flex justify-between items-center">
                            🏢 Struktura Organizacyjna
                            <span className="text-[10px] font-bold text-blue-500 cursor-pointer">EDYTUJ</span>
                        </h3>
                        <div className="space-y-4">
                            <div className="p-4 border-2 border-[var(--color-role-primary)] rounded-[var(--radius-base)] text-center relative">
                    ...
                    {/* Audit Logs */}
                    <Card id={2}>
                        <h3 className="text-lg font-black mb-6">📄 Ostatnie Akcje (Audyt)</h3>
                        ...
                        <Button id={1} className="w-full mt-6 text-[10px] bg-transparent border-[var(--color-role-neutral-border)] text-[var(--color-text-primary)]">ZOBACZ PEŁNY AUDYT</Button>
                    </Card>
                </Grid>
            </div>
        </main>
