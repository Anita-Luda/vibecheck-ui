...
export const EducationMock = () => (
    <div className="max-w-7xl mx-auto space-y-12 py-12 p-4">
        <header className="flex justify-between items-center border-b-2 border-[var(--color-role-neutral-border)] pb-6">
            <div className="flex items-center gap-6">
                ...
                <div className="text-xs font-black uppercase text-[var(--color-text-muted)] flex gap-4">
        ...
        <div className="grid grid-cols-4 gap-8">
            <aside className="space-y-8">
                <section>
                    <h3 className="text-xs font-black uppercase text-[var(--color-text-muted)] tracking-widest mb-4">Twój Postęp</h3>
                    <div className="space-y-4">
                        <Card id={0} className="p-4 bg-[var(--color-role-primary-bg)] border-[var(--color-role-primary-border)]">
                        ...
                        <Card id={1} className="p-4 bg-[var(--color-role-accent-bg)] border-[var(--color-role-accent-border)]">
                ...
                <section>
                    <h3 className="text-xs font-black uppercase text-[var(--color-text-muted)] tracking-widest mb-4">Następna Lekcja</h3>
                    <Card id={4} className="p-0 overflow-hidden">
                        ...
                        <div className="p-4">
                            <div className="text-xs font-black text-[var(--color-role-accent)] mb-1">LEKCJA 7</div>
                            <h4 className="font-bold text-sm text-[var(--color-text-primary)] mb-4">Zaawansowana orkiestracja ogonów kotów</h4>
            ...
            <main className="col-span-3 space-y-8">
                <section>
                    <h2 className="text-2xl font-black mb-6 text-[var(--color-text-primary)]">Twoje Aktywne Kursy</h2>
                    <Grid cols={2}>
                        {[
                            ...
                            <Card key={i} id={i%4} className="flex gap-4 p-4 hover:scale-[1.02] transition-transform cursor-pointer">
                ...
                <section className="grid grid-cols-2 gap-8">
                    <div>
                        <h3 className="text-xl font-black mb-4">🏆 Ostatnie Odznaki</h3>
                        <div className="flex flex-wrap gap-4">
                            {['🎖️ Master Fryer', '🥇 Cat Whisperer', '🥉 Entropy Junior', '🥈 Space Cadet'].map((badge, i) => (
                                <div key={i} className="flex flex-col items-center gap-2 group">
                                    <div className="w-16 h-16 rounded-full bg-[var(--color-surface-raised)] border-2 border-[var(--color-role-accent)] flex items-center justify-center text-2xl group-hover:scale-125 transition-transform shadow-lg">
                                        {badge.split(' ')[0]}
                                    </div>
                    ...
                    <div>
                        <h3 className="text-xl font-black mb-4">💬 Forum Sektora</h3>
                        <List items={[
